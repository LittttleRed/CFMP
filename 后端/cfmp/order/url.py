...
urlpatterns = [
    ...
    path('payment/<str:payment_id>/cancel/', views.PaymentCancelAPIView.as_view(), name='payment-cancel'),

    # 通知相关路由
    path('notifications/', views.NotificationListAPIView.as_view(), name='notification-list'),
    path('notifications/<int:id>/', views.NotificationDetailAPIView.as_view(), name='notification-detail'),
